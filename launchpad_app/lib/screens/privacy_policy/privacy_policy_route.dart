              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Welcome to Launchpad! This privacy policy explains how we collect, use, disclose, and safeguard your information when you use our service. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the service.',
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.only(top: Insets.medium),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      '7. Communicate with you about products, services, offers, promotions, rewards, and events offered by Launchpad and others, and provide news and information we think will be of interest to you.\n'
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: Insets.small),
                    child: Text(
                      'We do not knowingly solicit information from or market to children under the age of 13. If we learn that we have collected personal information from a child under age 13 without verification of parental consent, we will delete that information as quickly as possible. If you believe we might have any information from or about a child under 13, please contact us at privacy@launchpad.com.',
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.only(top: Insets.medium),
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: Insets.small),
                    child: Text(
                      'Email: privacy@launchpad.com\n'
                      'Address: 123 Launchpad Lane, Innovation City, Tech State, 12345',
                    ),
                  ),
                ],
              ),
